...
#banner
def banner():
	print(cyan('   __  __ ___  ____        ',bold=True))
	print(cyan('  /  |/  / _ )/ __/        ',bold=True),green('[*] decompiled by Riky Ripaldo',bold=True))
	print(cyan(' / /|_/ / _  / _/	   ',bold=True),green('[!] Gunakan dengan bijak',bold=True))
	print(cyan('/_/  /_/____/_/===FB v2.0  ',bold=True),green('[+] Python:',bold=True),cyan('v2.7',bold=True))
	print ('\33[1;35m=============================================')
	print ('\33[5;37m* Recode :\33[32;1mRiky Ripaldo')
	print ('\33[5;37m* Suport :\33[36;1mKANG-NEWBIE')
	print ('\33[5;37m* Github :\33[31;1mhttps://github.com/Riky2094')
	print ('\33[5;37m* Bahasa :\33[0;32mPython')
	print ('\33[5;37m* Whatsapp :\33[1;35m+6285789116608')
	print ('\33[5;37m* Facebook :\33[1;33mfacebook.com/santuy2094')
	print ('\33[1;35m=============================================')
	print ('\33[1;37m')
try:
